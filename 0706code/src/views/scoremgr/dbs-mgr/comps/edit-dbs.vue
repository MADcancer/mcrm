    ...
    >
      <div style="width: 100%">
        ...
        >
          ...
          <el-form-item label="截止日：" label-width="100px" prop="endDate" :key="editForm.endDate">
            <el-date-picker
          ...
          <el-form-item label="频次：" label-width="100px" prop="rate">
          ...
          <el-form-item label="权益条件：" label-width="100px" prop="condition">
            <el-select :disabled="type==='info'" v-model="editForm.condition" placeholder="">
              <el-option label="请选择" value=""></el-option>
              <el-option v-for="(item,index) in $root.selectOption.condition" :key="index" :label="item.label" :value="item.value"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="条件：" label-width="100px" prop="logicForm">
          ...
          <el-form-item label="获得积分：" label-width="100px" prop="rewardPoint">
            <el-input
              maxlength="8"
          ...
          <el-form-item label="创建时间：" label-width="100px" v-if="type === 'info'">
            <el-input
              maxlength="8"
          ...
          <el-form-item label="创建人工号：" label-width="100px" v-if="type === 'info'">
            <el-input
              maxlength="8"
          ...
          <el-form-item label="创建人：" label-width="100px" v-if="type === 'info'">
            <el-input
              maxlength="8"
          ...
          <el-form-item label="修改时间：" label-width="100px" v-if="type === 'info'">
            <el-input
              maxlength="8"
           ...
           <el-form-item label="修改人工号：" label-width="100px" v-if="type === 'info'">
            <el-input
              maxlength="8"
           ...
           <el-form-item label="修改人：" label-width="100px" v-if="type === 'info'">
            <el-input
              maxlength="8"
...
export default {
    ...
    dialogEditVisible(value) {
      if (value) {
        ...
        if (this.type === 'create') {
          ...
          API.dbsmgr.getDbsPointRuleById(this.id).then(res => {
  ...
  computed: {
    setTitle() {
      ...
      ? '创建积分达标条件' : (this.type === 'info' ? '查看积分达标条件' : '修改积分达标条件')
    }
  },
  methods: {
    // 保存客户组积分调整信息
