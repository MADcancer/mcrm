...
<template>
  <div class="buy-container">
    <div class="buy-form">
      <div class="buy-form-row">
        <div class="buy-form-item">
          <div class="buy-form-item-babel">主题名称</div>
          <el-input
    ...
    <el-row class="buy-handelBtns cus-button">
      <el-button
        v-if="isAuth('sys:subact:create')"
        icon="el-icon-cj"
        @click="handleFuncBtn('add')"
        >创建</el-button
      >
      <el-button v-if="isAuth('sys:subact:update')" icon="el-icon-xg" @click="handleFuncBtn('edit')"
        >修改</el-button
      >
      <el-button v-if="isAuth('sys:subact:update')" icon="el-icon-xg" @click="handleFuncBtn('stock')"
        >添加库存</el-button
      >
      <el-button
        v-if="isAuth('sys:subact:online')"
        icon="el-icon-sx"
        @click="handleFuncBtn('online')"
        >正式上线</el-button
      >
      <el-button
        v-if="isAuth('sys:subact:grayOnline')"
        icon="el-icon-sx"
        @click="handleFuncBtn('grayOnline')"
        >灰度上线</el-button
      >
      <el-button
        v-if="isAuth('sys:subact:offline')"
        icon="el-icon-xx"
        @click="handleFuncBtn('offline')"
        >下线</el-button
      >
      <el-button v-if="isAuth('sys:subact:delete')" icon="el-icon-sc" @click="handleFuncBtn('delete')"
        >删除</el-button
      >
      <el-button
        icon="el-icon-copy"
    ...
    >
      <span>{{
        btnType === 'delete'
          ...
          : btnType === 'online'
          ? '是否确认正式上线主题活动？'
          : btnType === 'grayOnline' ? '是否确认灰度上线主题活动' : '是否确认下线主题活动？'
      }}</span>
        ...
        if (type === 'copy') {
          ...
          if (type === 'online' || type === 'grayOnline') {
            ...
            if (type === 'grayOnline' &&
              ...
              this.showMessage('上线状态的活动不能能灰度上线!', 'warning')
              return
            }
            if (
