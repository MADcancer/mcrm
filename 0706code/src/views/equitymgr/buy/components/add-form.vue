  ...
  <div class="act-dialog">
    <el-dialog :title="setTitle" :visible.sync="dialogVisible"
      ...
      <div v-loading="waitLoading">
        ...
        <info-form ref="infoChild" v-show="active === 1" :active="active" :type="type" :actId="actId" @handleNext="handleNext" @handleLoading="handleLoading"></info-form>
        <rule-form ref="ruleChild" v-show="active === 2" :active="active" :type="type" :actId="actId" @handleNext="handleNext"></rule-form>
