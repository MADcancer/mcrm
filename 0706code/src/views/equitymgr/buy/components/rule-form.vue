      ...
      <div class="rule-form-row">
        <el-form-item label="商品名称:" prop="prodName">
          <el-input :disabled="true" placeholder="请查询" v-model="ruleForm.prodName">
            <i slot="suffix" v-if="type !== 'detail'" class="el-input__icon el-icon-khz" @click="proDialogVisible = true"></i>
          </el-input>
        </el-form-item>
        <el-form-item label="每人每日限购数量:" prop="oneBuyAmountD">
          <el-input :disabled="type === 'detail'" placeholder="请输入" v-model="ruleForm.oneBuyAmountD"></el-input>
        </el-form-item>
        <el-form-item label="每人限购总数量:" prop="oneBuyAmount">
          <el-input :disabled="type === 'detail'" placeholder="请输入" v-model="ruleForm.oneBuyAmount"></el-input>
        </el-form-item>
      </div>
      <div class="rule-form-row">
        <el-form-item label="活动商品限定数量:" prop="buyAmount">
          <el-input :disabled="type === 'detail'" placeholder="请输入" v-model="ruleForm.buyAmount" @change="changeProdUp"></el-input>
        </el-form-item>
          ...
          <div class="search-input">
            ...
            <div class="search-input-item">
              ...
              <el-select v-model="searchParams.suppChannel" placeholder="请选择" disabled>
                <el-option v-for="(item,index) in $root.selectOption.channel" :key="index" :label="item.label" :value="item.value"></el-option><el-option v-for="item in channelOptions" :key="item.key" :label="item.name" :value="item.key" />
              </el-select>
            </div>
            <div class="search-input-item">
