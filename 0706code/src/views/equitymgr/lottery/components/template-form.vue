<template>
  <div class="info-form">
    <el-form :model="templateForm" ref="templateForm" label-width="110px" class="demo-dynamic" size="mini"
      label-position="left">
      <div class="info-form-row">
        <el-form-item label="活动标题文字:" prop="actHead"  :rules="[{ required: true, message: '请输入', trigger: 'blur' }, {min: 0, max: 60, message: '长度限制60字符内', trigger: 'blur'}]">
          <el-input :disabled="type === 'detail'" placeholder="请输入"  maxlength="60" v-model="templateForm.actHead"></el-input>
        </el-form-item>
      </div>
      <div class="info-form-row">
        <div class="info-form-row">
          <el-form-item label="活动细则:" prop="actRules"  :rules="[{ required: true, message: '请输入', trigger: 'blur' }, {min: 0, max: 500, message: '长度限制500字符内', trigger: 'blur'}]">
            <el-input :disabled="type === 'detail'" type="textarea" :rows="8" placeholder="请输入"  maxlength="500" v-model="templateForm.actRules"></el-input>
          </el-form-item>
        </div>
      </div>
    ...
    <el-dialog class="lottery-notice-dialog" title="提示" :visible.sync="noticeDialogVisible" width="375px" append-to-body>
      <span>是否确认提交？</span>
