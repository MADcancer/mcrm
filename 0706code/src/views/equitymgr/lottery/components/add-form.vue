  ...
  <div class="act-dialog">
    <el-dialog :title="setTitle" :visible.sync="dialogVisible"
      ...
      <div v-loading="waitLoading">
        ...
        <rule-form ref="ruleChild" v-show="active === 2" :actId="actId" :type="type" :active="active" :actStatus="actStatus" :lotteryType="lotteryType" :typeChanged="typeChanged"
    ...
    methods: {
      ...
      handleNext(obj) {
        ...
        if (this.active === 1) {
          ...
          API.lottery.postSaveLotteryActBaseData(Object.assign({
          ...
          API.lottery.postSaveLotteryActProdData(Object.assign({
            actId: this.actId,
          ...
          API.lottery.postSaveLotteryActTemplateData(Object.assign({
            actId: this.actId,
            createEmpName: this.$store.state.user.name,
            createEmpNo: this.$store.state.user.id
          }, obj)).then(response => {
