  ...
  <div class="act-subject">
    <div class="search">
      ...
      <div class="inline">
        <span>主题开始时间</span>
        <el-date-picker
					v-model="searchParams.subBegtime"
					type="date"
        ...
        <span>主题结束时间</span>
        <el-date-picker
					v-model="searchParams.subEndtime"
					type="date"
					value-format="yyyy/MM/dd"
					format="yyyy/MM/dd"
          ...
          >
			...
			<div class="inline">
        <span>主题渠道</span>
				<el-select v-model="searchParams.subChannel" placeholder="请选择">
    ...
    <div class="result table">
      <div class="cus-button handle" style="margin-bottom: 14px">
        <el-button icon="el-icon-create" v-if="isAuth('sys:subject:create')"  @click="showdialog('create')"
          >创建</el-button
        >
        <el-button icon="el-icon-upd" v-if="isAuth('sys:subject:upd')"  @click="showdialog('update')"
          :disabled="buttonDisabled">修改</el-button
        >
        <el-button icon="el-icon-del" v-if="isAuth('sys:subject:del')"  @click="showdialog('del')"
...
export default {
  ...
  methods: {
    ...
    onSearchBtn() {
      // 查询校验
      if (
        this.searchParams.subBegtime &&
        this.searchParams.subEndtime &&
        new Date(this.searchParams.subEndtime).getTime() <
          new Date(this.searchParams.subBegtime).getTime()
      ) {
