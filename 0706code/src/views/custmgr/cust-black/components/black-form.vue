<template>
  <div class="custinfo-dialog">
    <el-dialog title="移出黑名单" :visible.sync="dialogVisible" width="518px" :before-close="handleClose">
      <div>
        ...
        <el-form ref="form" :model="form" :rules="rules" label-width="100px" label-position="left">
          <el-form-item class="custinfo-dialog-reason" label="移出原因" prop="applicationRea">
