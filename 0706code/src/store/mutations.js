...
export default {
  ...
  [types.UPDATE_CONTENT_TABS_ACTIVE_NAME](state, { name }) {
    ...
    // state.contentTabsActiveName = 'role'
  },
  // ADD by yueyao ST
  [types.SET_CONTENT_LAYOUT_PADDING](state, { top }) {
    state.contentPaddingTop = top
  },
  [types.UPDATE_SUB_MENU_NAV_LIST](state, list) {
    state.subMenuNavList = list
  }
  // ADD by yueyao END
}
