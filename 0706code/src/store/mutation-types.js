...
// ADD by yueyao ST
export const SET_CONTENT_LAYOUT_PADDING = 'SET_CONTENT_LAYOUT_PADDING'
export const UPDATE_SUB_MENU_NAV_LIST = 'UPDATE_SUB_MENU_NAV_LIST'
// ADD by yueyao END
// 用户
export const UPDATE_USER_ID = 'UPDATE_USER_ID'
export const UPDATE_USER_NAME = 'UPDATE_USER_NAME'
export const UPDATE_USER_ROLE_ID = 'UPDATE_USER_ROLE_ID'
export const UPDATE_USER_ROLE_NAME = 'UPDATE_USER_ROLE_NAME'
